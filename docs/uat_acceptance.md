...
Run every script with migrated staging data in Arabic and English. Record tester, date, company, evidence link, defects, retest, and signature.
...
| Manager | Reasoned checkout override, amendment/repricing approval, payment review, cross-role report review |

Acceptance requires zero unexplained accounting differences and no cross-company or cross-role data leakage.
...
Supervisor, Housekeeping, Maintenance, Accountant, and Manager access.
...
- Verify active-company and business-date persistence through Dashboard, Planning,
  drill-downs, and new reservations, including a failed refresh.
- Verify the custom tape has no drag/resize affordance and that the native Reservation Planner
...
Every run records browser/version, viewport, language/direction, role, company,
